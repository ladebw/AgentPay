...
class Web3BlockchainClient(BlockchainClient):
    ...
    def __init__(self, rpc_url: str, usdc_address: str, private_key: Optional[str] = None, key_manager: Optional[KeyManager] = None):
    ...
    async def transfer_usdc(
        ...
        # Sign transaction
        signing_key_manager = key_manager if key_manager is not None else self.key_manager
    ...
    async def estimate_gas(
        ...
        return {
            ...
            "total_cost_usd": float(gas * gas_price) / 1e18 * 3000,  # approximate USD using ETH price
        }