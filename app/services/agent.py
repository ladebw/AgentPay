...
class AgentService(BaseService[Agent]):
    ...
    async def create_agent(self, name: str, permissions: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    async def update_permissions(self, agent_id: str, permissions: Dict[str, Any]) -> Optional[Agent]:
