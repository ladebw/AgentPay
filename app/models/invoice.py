...
class Invoice(Base):
    ...
    # Relationships
    from_agent = relationship("Agent", foreign_keys=[from_agent_id], back_populates="invoices_sent")
    to_agent = relationship("Agent", foreign_keys=[to_agent_id], back_populates="invoices_received")
